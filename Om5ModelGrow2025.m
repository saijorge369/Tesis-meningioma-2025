...
% *****************************************************************
% Descripción:
%   Este código realiza el ajuste de cinco modelos (Exponencial, 
%   Power, Logístico, Gompertz y VAJU) a los datos obtenidos de un 
...
%   "48, 222, 242") y luego elegir interactivamente:
...
while true
    ...
    xlabel('Tiempo (meses)', 'FontSize', 16, 'FontWeight', 'bold');
    ylabel('Volumen (cm³)', 'FontSize', 16, 'FontWeight', 'bold');
    title(sprintf('Ajuste de los 5 modelos para el paciente ID %d', plotID), 'FontSize', 18, 'FontWeight', 'bold');
    legend('show', 'FontSize', 14, 'Location', 'northwest');
    grid on;
    hold off;
